# Generated by Powerlevel10k configuration wizard on 2024-07-08 at 14:29 MDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=2 #3
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=2
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=2 #3
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=0 #3
  typeset -g POWERLEVEL9K_CONTEXT_BACKGROUND=9 #0

  # Context format when running with privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%B%n@%m%b'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%B%n@%m%b'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%B%n@%m%b'
  ...
  function prompt_username() {
	  p10k segment -f "black" -b "red" -t "%B%n@%m%b"
  }
